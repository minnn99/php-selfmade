          ...
          <div className="space-y-4">
            {isMaleUser ? (
              <div className="text-center bg-amber-50 border border-amber-200 rounded-lg p-6">
                ...
                <h3 className="text-lg font-medium text-amber-900 mb-2">招待コード生成は利用できません</h3>
                <p className="text-amber-700 mb-4">男性アカウントでは招待コードの生成機能をご利用いただけません。パートナーから招待コードを受け取って参加してください。</p>
                <button
                  onClick={() => setActiveTab("connect")}
                  className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg text-sm font-medium transition-colors"
                >
