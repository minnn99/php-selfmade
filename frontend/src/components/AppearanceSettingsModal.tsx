      ...
      <div className="bg-white rounded-t-xl sm:rounded-xl shadow-2xl w-full sm:max-w-3xl sm:w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">外観設定</h2>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[
                  ...
                  <label key={mode.value} className="flex items-center">
                    ...
                    />
                    <div className="w-full p-3 sm:p-3 text-center border border-gray-300 rounded-lg cursor-pointer peer-checked:border-primary-500 peer-checked:bg-primary-50 hover:bg-gray-50 active:bg-gray-100 transition-colors min-h-[44px] flex flex-col items-center justify-center">
                      <div className="text-lg sm:text-lg mb-1">{mode.icon}</div>
