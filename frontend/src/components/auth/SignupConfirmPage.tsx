        ...
        <ScaleIn delay={100}>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="border-b border-neutral-200 pb-3 sm:pb-4">
              ...
              <p className="text-base sm:text-lg text-neutral-900 font-medium break-words">{signupData.name}</p>
            </div>
            ...
            <div className="border-b border-neutral-200 pb-3 sm:pb-4">
              ...
              <p className="text-base sm:text-lg text-neutral-900 font-medium">{getGenderLabel(signupData.gender)}</p>
            </div>

            {/* Phone */}
            <div className="border-b border-neutral-200 pb-3 sm:pb-4">
              <label className="block text-sm font-medium text-neutral-600 mb-1">電話番号</label>
              <p className="text-base sm:text-lg text-neutral-900 font-medium">{signupData.phone}</p>
            </div>

            {/* Email */}
            <div className="border-b border-neutral-200 pb-3 sm:pb-4">
              <label className="block text-sm font-medium text-neutral-600 mb-1">メールアドレス</label>
              <p className="text-base sm:text-lg text-neutral-900 font-medium break-all">{signupData.email}</p>
            </div>
            ...
            <div className="pb-3 sm:pb-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <p className="text-sm sm:text-base text-neutral-600">パスワードが設定されました</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
            ...
            <button
              onClick={onEdit}
              disabled={isLoading}
              className="w-full bg-neutral-100 hover:bg-neutral-200 disabled:bg-neutral-50 text-neutral-700 font-medium py-3 px-4 rounded-lg transition-colors duration-200 disabled:cursor-not-allowed touch-manipulation min-h-[48px] text-base"
            >
              内容を修正する
            </button>
          </div>
