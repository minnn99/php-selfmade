  ...
  const renderBasicInfo = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">ニックネーム</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">本名</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">電話番号</label>
          <input
            type="tel"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">生年月日</label>
          <input
            type="date"
            ...
            className="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm min-h-[44px] touch-manipulation bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
          />
          {calculateAge() && <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">年齢: {calculateAge()}歳</p>}
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">性別</label>
          <div className="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-sm min-h-[44px] flex items-center text-gray-600 dark:text-gray-300">
            {getGenderDisplay(profileData.gender)}
          </div>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">性別は変更できません</p>
        </div>
      </div>
        ...
        <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <h3 className="text-sm font-medium text-red-800 dark:text-red-300">アカウント削除</h3>
  ...
  const renderHealthInfo = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">身長 (cm)</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">体重 (kg)</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">血液型</label>
          <select
      ...
      {calculateBMI() && (
        <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-3">
          <p className="text-sm text-blue-800 dark:text-blue-300">BMI: {calculateBMI()}</p>
        </div>
      )}

      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">アレルギー</label>
        <textarea
          value={profileData.allergies || ""}
          onChange={(e) => updateField("allergies", e.target.value)}
          rows={3}
          placeholder="食物アレルギー、薬物アレルギーなど"
          className="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 min-h-[80px] touch-manipulation"
        />
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">現在服用中の薬</label>
        <textarea
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 whitespace-nowrap">既往歴</label>
        <textarea
          value={profileData.medicalHistory || ""}
          onChange={(e) => updateField("medicalHistory", e.target.value)}
          rows={4}
          placeholder="過去の病気、手術歴、入院歴など"
          className="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 min-h-[100px] touch-manipulation"
        />
      </div>
    </div>
  );
      ...
      <div className="bg-white dark:bg-gray-800 rounded-t-xl sm:rounded-xl shadow-2xl w-full sm:max-w-4xl sm:w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          <div className="flex items-center">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">プロフィール設定</h2>
          </div>
