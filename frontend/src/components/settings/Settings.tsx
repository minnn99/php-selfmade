            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              {settingItems.map((item) => (
                <button
                  ...
                  className="flex items-center p-3 sm:p-4 rounded-lg hover:bg-neutral-50 dark:hover:bg-gray-700 active:bg-neutral-100 dark:active:bg-gray-600 transition-colors text-left group border border-gray-200 dark:border-gray-600 hover:border-primary-300 dark:hover:border-primary-600 min-h-[44px]"
                >
                  <div className="flex-shrink-0 p-2 sm:p-3 bg-primary-50 dark:bg-primary-900/30 rounded-lg text-primary-600 dark:text-primary-400 group-hover:bg-primary-100 dark:group-hover:bg-primary-900/50 transition-colors">
                    {item.icon}
                  </div>
                  <div className="ml-3 sm:ml-4 flex-1 min-w-0">
                    <div className="flex items-center">
                      <h3 className="text-sm sm:text-base font-medium text-neutral-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors truncate">
                        {item.title}
                      </h3>
                      {item.badge && (
                  ...
                  <div className="flex-shrink-0 ml-2">
                    <svg
                      className="w-4 h-4 text-neutral-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
