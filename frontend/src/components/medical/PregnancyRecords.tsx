    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-medical dark:border-gray-700 p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-3 sm:space-y-0">
        <div className="flex items-center">
          <button onClick={onBack} className="mr-3 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors touch-manipulation">
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1">
              <input
                ...
                readOnly
                className="w-full px-3 py-2 pr-8 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[44px] touch-manipulation cursor-pointer bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              />
              <svg
            ...
            {(searchWeek || searchDate || searchType) && (
              <button
                ...
                className="px-3 py-2 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 active:text-gray-900 dark:active:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors min-h-[44px] touch-manipulation"
              >
                クリア
              </button>
            )}
            ...
            <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10">
              <div className="p-4 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">週数</label>
                    <input
                      type="number"
                      placeholder="例: 5"
                      value={searchWeek}
                      onChange={(e) => setSearchWeek(e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[36px] touch-manipulation bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[36px] touch-manipulation bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">種類</label>
                    <select
                      value={searchType}
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-primary-600 hover:bg-primary-700 active:bg-primary-800 text-white rounded-lg transition-colors min-h-[32px] touch-manipulation"
                  >
                    完了
                  </button>
                </div>
      ...
      {/* Add Record Form */}
      {showAddRecord && (
        <div className="mb-4 sm:mb-6 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-3 sm:p-4 space-y-3 sm:space-y-4">
          <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white text-center sm:text-left">新しい記録を追加</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <select
              value={newRecord.type}
              onChange={(e) => setNewRecord({ ...newRecord, type: e.target.value as "symptom" | "test" | "appointment" | "note" })}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[44px] touch-manipulation bg-white dark:bg-gray-600 text-gray-900 dark:text-white"
            >
              <option value="symptom">症状</option>
              <option value="test">検査</option>
              <option value="appointment">診察</option>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[44px] touch-manipulation bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            />
          </div>
          <textarea
            placeholder="詳細内容"
            ...
            rows={3}
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[88px] touch-manipulation bg-white dark:bg-gray-600 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
          />
          {newRecord.type === "test" && (
            <input
              type="text"
          ...
          <div className="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-2">
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 active:text-gray-900 dark:active:text-white border border-gray-300 dark:border-gray-600 rounded-lg text-sm min-h-[44px] touch-manipulation bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-500"
            >
              キャンセル
            </button>
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 bg-primary-600 hover:bg-primary-700 active:bg-primary-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg text-sm transition-colors min-h-[44px] touch-manipulation"
            >
              保存
            </button>
          </div>
      ...
      <div className="space-y-6">
        {pregnancyRecords.length === 0 ? (
          <div className="text-center py-8 sm:py-12">
            <p className="text-gray-500 dark:text-gray-400 text-sm px-4">まだ記録がありません</p>
            <button
              onClick={() => setShowAddRecord(true)}
              className="mt-3 sm:mt-4 px-4 py-2 bg-primary-600 hover:bg-primary-700 active:bg-primary-800 text-white rounded-lg text-sm transition-colors min-h-[44px] touch-manipulation"
            >
              最初の記録を追加
            </button>
          </div>
          ...
          <div className="text-center py-6 sm:py-8">
            <p className="text-gray-500 dark:text-gray-400 text-sm px-4">検索条件に一致する記録がありません</p>
          </div>
        ) : (
          getPaginatedRecords().groups.map(({ week, records }) => (
            <div key={week} className="border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
              {/* Week Header */}
              <div className="bg-primary-50 dark:bg-primary-900/30 border-b border-primary-100 dark:border-primary-700 px-3 sm:px-4 py-3">
                <div className="flex items-center justify-between">
                  <h5 className="text-sm sm:text-base font-semibold text-primary-900 dark:text-primary-100">妊娠 {week}</h5>
                  <span className="text-xs text-primary-700 dark:text-primary-300">{records.length}件</span>
                </div>
              </div>
              ...
              <div className="space-y-0">
                {records.map((record, index) => {
                  ...
                  return (
                    <div key={record.id} className={`relative p-3 sm:p-4 bg-white dark:bg-gray-800 ${index !== records.length - 1 ? "border-b border-gray-100 dark:border-gray-700" : ""}`}>
                      {/* Display Mode */}
                            ...
                            <div className="flex flex-wrap items-center mb-2">
                              <span
                                className={`
                                  ...
                                  ${record.type === "symptom" ? "bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300" : ""}
                                  ${record.type === "test" ? "bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300" : ""}
                                  ${record.type === "appointment" ? "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300" : ""}
                                  ${record.type === "note" ? "bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300" : ""}
                                `}
                              >
                                {getTypeLabel(record.type)}
                              </span>
                              <h6 className="font-medium text-gray-900 dark:text-white text-sm break-words">{record.title}</h6>
                            </div>
                            <p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm mb-2 whitespace-pre-wrap break-words leading-relaxed">{record.description}</p>
                            {record.value && <p className="text-primary-600 dark:text-primary-400 text-xs sm:text-sm font-medium break-words">結果: {record.value}</p>}
                          </div>
                          <div className="text-right flex-shrink-0 sm:ml-4">
                            <div className="text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap">{formatDate(record.date)}</div>
                            <div className="text-xs text-primary-600 dark:text-primary-400 font-medium whitespace-nowrap sm:mb-2">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full mx-4 p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">記録を編集</h3>
                <button
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[44px] touch-manipulation bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    >
                      <option value="symptom">症状</option>
                      <option value="test">検査</option>
                      <option value="appointment">診察</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[44px] touch-manipulation bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                      placeholder="タイトルを入力"
                    />
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">詳細内容</label>
                  <textarea
                    value={editingRecord.description}
                    onChange={(e) => setEditingRecord({ ...editingRecord, description: e.target.value })}
                    rows={4}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[100px] touch-manipulation bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                    placeholder="詳細内容を入力"
                  />
                </div>
                ...
                {editingRecord.type === "test" && (
                  <div>
                    <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">検査結果</label>
                    <input
                      type="text"
                      placeholder="検査結果を入力"
