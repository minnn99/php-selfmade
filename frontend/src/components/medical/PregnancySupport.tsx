  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm border border-medical p-4 sm:p-6 ${className}`}>
      ...
      {!isPregnancyMode ? (
        ...
        <div className="space-y-6">
          ...
          {!isPregnant ? (
            ...
            <div className="bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200 rounded-lg p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                <div className="flex flex-row justify-between items-start sm:flex-col sm:flex-1">
                  <div className="flex-1 sm:flex-none">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h3 className="text-base sm:text-lg font-medium text-pink-900">妊娠中</h3>
                    </div>
                  ...
                  <div className="flex flex-col items-end sm:hidden">
                    <div className="text-right mb-2">
                      ...
                      <div className="text-xs text-pink-700">妊娠週数</div>
                    </div>
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 text-xs font-medium text-pink-700 bg-white hover:bg-pink-50 active:bg-pink-100 border border-pink-300 rounded-lg transition-colors min-h-[36px] touch-manipulation"
                        title="妊娠状態を取り消し"
                      >
                        取り消し
                      </button>
                ...
                <div className="hidden sm:flex sm:flex-row sm:items-center sm:space-x-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      onClick={() => setShowCancelPregnancyModal(true)}
                      className="px-4 py-2 text-sm font-medium text-pink-700 bg-white hover:bg-pink-50 active:bg-pink-100 border border-pink-300 rounded-lg transition-colors min-h-[40px] touch-manipulation"
                      title="妊娠状態を取り消し"
                    >
                      取り消し
                    </button>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="px-3 py-2 text-sm text-gray-600 hover:text-gray-700 active:text-gray-800 hover:bg-gray-50 rounded-lg transition-colors min-h-[40px] touch-manipulation"
                >
                  過去の記録
                </button>
              </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 p-4 sm:p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">妊娠記録の終了</h3>
              </div>

              <div className="mb-4 sm:mb-6">
                <p className="text-sm sm:text-base text-gray-700 mb-3">妊娠記録を終了して保存しますか？</p>
                ...
                <p className="text-sm text-gray-500 mt-3">※ 保存された記録は後から「すべて見る」で確認できます</p>
              </div>
      ...
      {showHistoryModal &&
        createPortal(
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full mx-4 p-4 sm:p-6 max-h-[80vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">過去の妊娠記録</h3>
                <button
              ...
              <div className="space-y-4">
                {pregnancyHistory.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 text-sm">保存された妊娠記録がありません</p>
                    <p className="text-gray-400 text-xs mt-2">妊娠記録を終了すると、ここに記録が保存されます</p>
                  </div>
                ) : (
                  pregnancyHistory.map((history, index) => (
                    <div key={index} className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                        <div>
                          <h4 className="font-medium text-gray-900">妊娠記録 #{index + 1}</h4>
                        ...
                        <div className="text-right">
                          <p className="text-sm text-gray-500">{history.records_data?.length || 0} 件の記録</p>
                          <button
                            onClick={() => {
                            ...
                            className="text-sm text-primary-600 hover:text-primary-700 active:text-primary-800 hover:underline"
                          >
                            詳細を見る
                          </button>
                        </div>
