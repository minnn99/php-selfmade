      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-medium text-gray-900">バックアップ作成</h3>
              <p className="text-sm text-gray-500">全てのデータと設定の完全バックアップを作成</p>
            </div>
            <button
              onClick={handleCreateBackup}
              disabled={isExporting}
              className="flex items-center px-4 py-3 bg-primary-600 hover:bg-primary-700 disabled:bg-gray-400 text-white rounded-lg transition-colors"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10" />
              </svg>
              {isExporting ? "作成中..." : "完全バックアップを作成"}
            </button>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500">指定した形式でデータを書き出し</p>
            </div>

            <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
              {/* エクスポート形式 */}
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">エクスポート形式</label>
              ...
              {/* 日付範囲 */}
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">データ範囲</label>
                <select
              ...
              {exportFormat === "json" && (
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-700">設定データを含める</span>
                </label>
              )}
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500">バックアップファイルからデータを復元</p>
            </div>
            ...
            <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-500"
                />
                <span className="ml-2 text-sm text-gray-700">設定データもインポートする</span>
              </label>
              ...
              <label className="block">
                ...
                />
                {isImporting && <p className="text-sm text-gray-600 mt-2">インポート中...</p>}
              </label>
            </div>
          </div>
