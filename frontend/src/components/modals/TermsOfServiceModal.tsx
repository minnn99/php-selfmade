...
export const TermsOfServiceModal: React.FC<TermsOfServiceModalProps> = ({ isOpen, onClose }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-black dark:bg-opacity-70 flex items-center justify-center p-4 z-[9999]">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white">利用規約</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第1条（適用）</h3>
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第2条（利用登録）</h3>
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第3条（サービス内容）</h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第4条（利用者の義務）</h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第5条（禁止事項）</h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第6条（サービスの変更・停止）</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第7条（個人情報の取扱い）</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第8条（免責事項）</h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第9条（利用停止・退会）</h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第10条（準拠法・管轄裁判所）</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">第11条（規約の変更）</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
