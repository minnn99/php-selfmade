      ...
      <div className="max-w-4xl w-full space-y-8 sm:space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto">
          <div className="text-center p-4 sm:p-6 bg-white/50 rounded-xl border border-medical/20 shadow-sm touch-manipulation">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-neutral-900 mb-2">健康データの記録</h3>
          ...
          <div className="text-center p-4 sm:p-6 bg-white/50 rounded-xl border border-medical/20 shadow-sm touch-manipulation">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-neutral-900 mb-2">スマートリマインダー</h3>
            <p className="text-neutral-600 text-xs sm:text-sm">
        ...
        {/* Footer */}
        <div className="text-center text-neutral-500 text-xs sm:text-sm px-4">
